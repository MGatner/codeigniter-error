...
<section>
	...
	<p>A small file to test downloading in general: <?= anchor('home/small', 'Small') ?></p>
	<p>A large file designed to exceed PHP <strong>memory_limit</strong>: <?= anchor('home/large', 'Large') ?></p>
